...
public class DefaultMethodExample2 {
    ...
    static Comparator<Student> nameComparator = Comparator.comparing(Student::getName).reversed(); // reverse order
    ...
    public static void sortWithNullValues(){
        List<Student> studentList = StudentDataBase.getAllStudents();
    	 Comparator<Student> nullFirst = Comparator.nullsFirst(nameComparator);
