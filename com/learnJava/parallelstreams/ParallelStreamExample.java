...
public class ParallelStreamExample {
    ...
    public static int sum_parallel_stream(){
        int total = IntStream.rangeClosed(1,1000000)
                  .parallel() // splits the data in to multiple parts 
                  			//each part will be implemented on different processor cores
    ...
    public static void main(String[] args) {
        ...
        System.out.println("sequential stream results in MilliSeconds: " + sequentialDuration);
        ...
        System.out.println("parallel stream results in MilliSeconds: " + parallelDuration);
